...
const BranchesCard: React.FC<BranchesCardProps> = ({
  ...
  return (
    <Card
      className={`border-b-4 ${bottomBorderColor} rounded-b-none shadow-md lg:max-w-[25rem]`}
    >
      <CardHeader className="text-left p-8">
        ...
        <CardDescription className="text-sm text-cardSecondary font-medium text-left sm:text-base sm:font-normal">
          {description}
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className="p-8 pt-0">
        ...
        >
          <p
            className={`${textColor} ${hoverBorderColor} border-b-[1.5px] border-b-transparent text-sm font-semibold lg:text-base`}
          >
            {learnMoreText}
          </p>
          <svg
